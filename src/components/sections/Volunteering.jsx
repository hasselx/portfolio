      ...
      <div className="block sm:hidden">
        ...
        >
            ...
            {portfolioData.volunteering.map((item, index) => (
              <CarouselItem key={index}>
                <div className="p-1 h-full">
                  <Card className="p-6 flex flex-col h-full bg-surface group transition-all duration-300">
                    <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary mb-6 group-hover:bg-primary group-hover:text-slate-900 transition-colors">
                      <Heart size={24} />
                    </div>
                    <h3 className="text-xl font-bold text-slate-100 mb-3 group-hover:text-primary transition-colors">{item.title}</h3>
          ...
          <div className="flex items-center justify-center gap-4 mt-6">
            <CarouselPrevious className="static translate-y-0 translate-x-0 bg-surface/50 hover:bg-surface border-slate-700 hover:text-primary hover:border-primary transition-all duration-300" />
            <CarouselNext className="static translate-y-0 translate-x-0 bg-surface/50 hover:bg-surface border-slate-700 hover:text-primary hover:border-primary transition-all duration-300" />
          </div>
        </Carousel>
      </div>
    </SectionWrapper>
