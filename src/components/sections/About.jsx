    ...
    <SectionWrapper id="about">
      <div className="max-w-5xl mx-auto w-full flex flex-col items-center justify-center px-4 md:px-0">
        ...
        <div className="w-full">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-center gap-8 md:gap-12 mb-12 w-full">
            {/* Left: Video */}
            ...
            {/* Right: Text */}
            <div className="text-[17px] md:text-lg text-slate-300 leading-[1.8] font-light text-center md:text-left space-y-5">
              <p>
